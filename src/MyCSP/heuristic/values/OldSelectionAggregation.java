...
public final class OldSelectionAggregation implements IntValueSelector {
...
//	private int slots; // 总插槽数
	...
	public OldSelectionAggregation(IntVar[] vars, long seed, int[][] options, int[][] frequency, int[] nums) {
